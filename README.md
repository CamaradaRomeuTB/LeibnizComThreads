...
Existem dois scripts: o primeiro ('sequencial.cpp') faz o cálculo de forma simples, em um processo único; o segundo ('threads.cpp') divide o cálculo dos termos em diferentes threads, para execução paralela.
